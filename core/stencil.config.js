...
exports.config = {
  ...
  bundles: [
    ...
    { components: ['ion-item', 'ion-item-divider', 'ion-item-group', 'ion-label', 'ion-list', 'ion-list-header', 'ion-text'] },
    { components: ['ion-item-option', 'ion-item-options', 'ion-item-sliding'] },
    ...
    { components: ['ion-nav-pop', 'ion-nav-push'] },
